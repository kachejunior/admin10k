...
var mensaja_error_4='<p class="text-error">Disculpe el atleta se encuentra asignado en el evento "Carrera 10k" por favor dirigirse a la mesa correspondiente.</p>';
...
var mensaja_1='<p class="text-success">Felicidades ya se encuentra validado para participar en la "Caminata 5k" ¡Mucha Suerte!.</p>';
function vacio(q) {  
...
function validar(){
	...
	var url = base_url+'atletas_admin/validacion_caminata_envio';
