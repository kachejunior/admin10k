...
<div class='container'>
	<h2>Asignacion Numero de Caminata 5k</h2>
	<div class="control-group">
		...
		<div class="controls">
				<div class="span2">
					<label>Cedula</label>
					<input class="span11 cedula" name="cedula" id="cedula" type="text" placeholder="##########" maxlength='10' onchange="carga();" required>
...
<script src="<?php echo base_url();?>media/js/fn_validacion_caminata.js"></script>
